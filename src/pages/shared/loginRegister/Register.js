...
const Register = () => {
  ...
  return (
    <>
      <Header />
      <section>
        <div className="w-full max-w-md p-8 space-y-3 rounded-xl text-gray-100 bg-blue-600  mx-auto my-10">
          ...
          >
            <div className="space-y-1 text-sm">
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 rounded-mdborder-white bg-gray-600 text-gray-100 focus:border-red-400"
              />
            </div>
            <div className="space-y-1 text-sm">
              <label htmlFor="photoURL" className="block text-gray-100">
                Please Type Your  Photo-URL Here:
              </label>
              <input
                type="text"
                name="photoURL"
            ...
            <div className="space-y-1 text-sm">
              <label htmlFor="confirm" className="block text-gray-100">
            ...
            <button className="block w-full p-3 text-center rounded-sm text-gray-800 bg-white hover:bg-red-600">
               Please Register 
            </button>
          </form>
