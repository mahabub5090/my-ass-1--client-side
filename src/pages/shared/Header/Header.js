...
const Header = () => {
  ...
  return (
    <div className="px-4 py-4 mx-auto sm:max-w-xl md:max-w-full bg-cyan-200 lg:max-w-screen-xl md:px-24 lg:px-8">
      <div className="relative flex items-center justify-between">
        ...
        >
          ...
          <span className="ml-2 text-lg font-bold tracking-wide italic uppercase">
            Web-Technology
          </span>
        </Link>
          ...
          <button>
            ...
            >
              <span className="relative">
                ...
                <div className="w-10 h-6 rounded-full shadow-inner bg-slate-200 peer-checked:bg-red-400"></div>
